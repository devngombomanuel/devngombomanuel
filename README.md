...
Tenho interesse em **Arquiteturas e boas práticas de código**, **APIs REST**, **estruturas de dados e algoritmos.** Estou em constante aprendizado, buscando aprimorar minhas competências técnicas e contribuir para projetos que gerem impacto real.
...
- 🩺 Plataforma digital voltada para a gestão e acesso a serviços de saúde, oferecendo uma experiência moderna para pacientes e profissionais, com foco em eficiência, acessibilidade e transformação digital no setor da saúde.
